...
function reorderHandleDrop(e){
 this.style.borderTop='1px solid #999';
  ...
  function reorderHandleDragEnter(e) { this.style.borderTop='20px solid rgba(0,0,255,0.3)'; 
    }
    function  reorderHandleDragOver(e) { 
    }
   function   reorderHandleDragLeave(e) {  this.style.borderTop='1px solid #999';
    }
    
   function   reorderHandleDragEnd(e) {      this.style.borderTop='1px solid #999'; 
    }
