...
$(function(){$("#register form").validate({errorClass:"error",validClass:"valid",highlight:function(e,r,i){$(e).addClass(r).removeClass(i)},unhighlight:function(e,r,i){$(e).removeClass(r).addClass(i)},rules:{name:"required",email:"required",countrycode:"required",mobile:"required",country:"required",checkbox:"required"},errorPlacement:function(e,r){},messages:{name:"",email:"",countrycode:"",mobile:"",country:"",checkbox:""},submitHandler:function(e){e.submit()}}),$("#page").fadeIn("slow"),$("#page-loader").fadeOut("slow")});