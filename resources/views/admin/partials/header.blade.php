...
@endforeach
        ...
        <li class="dropdown"> <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="data:image/jpeg;base64,{{ current_user()->getAvatar() }}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{{ current_user()->getName() }}</b> </a>
          <ul class="dropdown-menu dropdown-user animated flipInY">
            <li><a href="{{ route('admin.users.profile') }}"><i class="ti-user"></i> {{ trans('general.Profile') }}</a></li>
            <li><a href=" {{ route('admin.users.changePassword') }}"><i class="ti-lock "></i>{{ trans('general.changePassword') }}</a></li>

                            <li role="separator" class="divider"></li>
                            <li><a href="{{route('admin.editProfile')}}"><i class="ti-settings"></i> Account Setting</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ route('admin.auth.logout') }}"><i class="fa fa-power-off"></i> {{ trans('general.Logout') }}</a></li>
                                                          </ul>
                                                          <!-- /.dropdown-user -->
                                                        </li>
                                                        <!-- /.dropdown -->
