...
<div class="panel">
   ...
   <table id='statistics_table' >
       ...
       <tr> <th>{{ trans('general.best_trade') }}</th><td><span class="tooltip_number" data-original-title="{{ trans('general.best_trade_tooltip') }}">{!! $statistics['best_trade'] !!}</span></td><th>{{ trans('general.profits_factor') }}</th><td>{!! $statistics['profits_factor'] !!}</td></tr>
       <tr> <th>{{ trans('general.worst_trade') }}</th><td><span class="tooltip_number" data-original-title="{{ trans('general.worst_trade_tooltip') }}">{!! $statistics['worst_trade'] !!}</span></td><th>{{ trans('general.expected_payoff') }}</th><td>{!! $statistics['expected_payoff'] !!}</td></tr>
