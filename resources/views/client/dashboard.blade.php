...
<div class="panel">
   ...
   <table id='statistics_table' >
       ...
       <tr> <th><span class="tooltip_number" data-original-title={{ trans('general.gross_loss_tooltip') }}>{{ trans('general.gross_loss') }}</span></th><td>{!! $statistics['gross_loss'] !!}</td><th>{{ trans('general.average_loss') }}</th><td>{!! $statistics['average_loss'] !!}</td></tr>
       <tr> <th><span class="tooltip_number" data-original-title={{ trans('general.maximum_consecutive_wins_tooltip') }}>{{ trans('general.maximum_consecutive_wins') }}</span></th><td>{!! $statistics['maximum_consecutive_wins'] !!}</td><th><span class="tooltip_number" data-original-title={{ trans('general.maximum_consecutive_losses_tooltip') }}>{{ trans('general.maximum_consecutive_losses') }}</span></th><td>{!! $statistics['maximum_consecutive_losses'] !!}</td></tr>
       <tr> <th><span class="tooltip_number" data-original-title={{ trans('general.maximal_consecutive_profit_tooltip') }}>{{ trans('general.maximal_consecutive_profit') }}</span></th><td>{!! $statistics['maximal_consecutive_profit'] !!}</td><th><span class="tooltip_number" data-original-title={{ trans('general.maximal_consecutive_loss_tooltip') }}>{{ trans('general.maximal_consecutive_loss') }}</span></th><td>{!! $statistics['maximal_consecutive_loss'] !!}</td></tr>
