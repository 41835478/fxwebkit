                    ...
                    <div class="white-box">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">{!! th_sort(trans('request::request.name'), 'name', $oResults) !!}</th>
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">{!! th_sort(trans('request::request.login'), 'login', $oResults) !!}</th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class="tr {{ $class }}">
                                        ...
                                        <td>
                                            <a href="{{ route('admin.request.assignAccountEdit').'?logId='.$oResult->id }}"
                                               class="fa fa-edit tooltip_number" data-original-title="{{trans('request::request.edit')}}"></a>
                                            @if($oResult->status != 1)

                                                <a href="{{ route('admin.request.forwordAssignAccount').'?logId='.$oResult->id }}"
                        ...
                        <div class="table">
                            ...
                            <div class="thead">
                                <div class="tr">
                                    ...
                                    <div class="th">{!! th_sort(trans('request::request.name'), 'name', $oResults) !!}</div>
