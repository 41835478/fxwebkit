    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group no-margin-hr">
                    ...
                    {!! Form::text('comment',$changeLeverage['comment'],['class'=>'form-control']) !!}
                </div>
            </div>
        </div>
        <!-- row -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group no-margin-hr">
                    ...
                    {!! Form::text('reason',$changeLeverage['reason'],['class'=>'form-control']) !!}
                </div>
            </div>
        </div>
        <!-- row -->
        ...
        <div class="col-sm-12">
            <div class="form-group no-margin-hr">
                ...
                {!! Form::select('status',$changeLeverage['status_array'],$changeLeverage['status'],['id'=>'jq-validation-select2','class'=>'form-control']) !!}
            </div>
        </div><!-- col-sm-6 -->
    </div>
    </div>
