    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('fxweb.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                <div class="col-lg-12">
                    <h4 class="page-title">{{ trans('request::request.changePassword') }}</h4>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        <li><a href="#">{{ trans('request::request.ModuleTitle') }}</a></li>
                        <li class="active">{{ trans('request::request.changePassword') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                        ...
                        <div class="table">
                            ...
                            <div class="thead">
                                <div class="tr">
                                    ...
                                    <div class="th">{!! th_sort(trans('request::request.newPassword'), 'newPassword', $oResults) !!}</div>
                                    <div class="th">{!! th_sort(trans('request::request.password_type'), 'password_type', $oResults) !!}</div>
