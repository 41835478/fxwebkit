...
class cms_forms_liveaccountController extends Controller
{
    ...
    public function cms_create()
    {
        ...
        $arrays=[];
        $arrays['default_platform']= [''=>'Select One','MT4'=>'MT4','Multi-products'=>'Multi-products','Both'=>'Both'];
        $arrays['account_type']= [''=>'Select One','Self-trading'=>'Self-trading','Managed investor'=>'Managed investor (managed account under a fund
                                        manager)s','Referring Partner'=>'Referring Partner','Fund manager'=>'Fund manager'];
        $arrays['base_currency_limit']= [''=>'Select One','USD'=>'USD','EUR'=>'EUR','GBP'=>'GBP'];
        $arrays['nationality']= [''=>'Select One','MT4'=>'MT4','Multi-products'=>'Multi-products','Both'=>'Both'];
        $arrays['gender']= [''=>'Select One','Male'=>'Male','Female'=>'Female'];
        $arrays['marital_status']= [''=>'Select One','Single'=>'Single','Married'=>'Married'];
        $arrays['resident_status']= [''=>'Select One','Non Resident'=>'Non Resident','Resident Individual'=>'Resident Individual','Foreign National'=>'Foreign National'];
        //   $arrays['country']= ['Non Resident'=>'Non Resident','Resident Individual'=>'Resident Individual','Foreign National'=>'Foreign National'];
        $arrays['source_funds_deposited_joint']= [''=>'Select One','Employment'=>'Employment inheritance investment','Previous'=>'Previous employment real state','Sale of'=>'Sale of investments savings','Other'=>'Other'];
        $arrays['proof_of_residence']= [''=>'Select One','Residence ID'=>'Residence ID','Utility Bill'=>'Utility Bill','Bank Statement'=>'Bank Statement'];
        $arrays['id_type']= [''=>'Select One','Driving Licence'=>'Driving Licence','Passport'=>'Passport','Residence ID'=>'Residence ID'];
        $arrays['number_of_years']= [''=>'Select One','None'=>'None','Less than 1 year'=>'Less than 1 year','1 to 3 years'=>'1 to 3 years','3 to 5 years'=>'3 to 5 years','More than 5 years'=>'More than 5 years'];
        $arrays['number_of_transactions']= [0=>'Select One','less than 10 transactions'=>'less than 10 transactions','10 to 20 transactions'=>'10 to 20 transactions','More than 20 transactions'=>'More than 20 transactions'];
        $arrays['average_trading']= [0=>'Select One','Less than 30,000 GBP'=>'Less than 30,000 GBP','30,000 to 60,000 GBP'=>'30,000 to 60,000 GBP','60,000 to 300,000 GBP'=>'60,000 to 300,000 GBP','More than 300,000 GBP'=>'More than 300,000 GBP'];
        $arrays['source_funds_deposited_joint']= [''=>'Select One','Employment'=>'Employment','Inheritance'=>'Inheritance','Investment'=>'Investment','Previous Employment'=>'Previous Employment','Real Estate'=>'Real Estate','Sale of investments'=>'Sale of investments','Savings'=>'Savings','Other (specify below)'=>'Other (specify below)',];
        $arrays['source_funds_deposited']= [''=>'Select One','Employment inheritance investment'=>'Employment inheritance investment','Previous employment real state'=>'Previous employment real state','Sale of investments savings'=>'Sale of investments savings','Other'=>'Other',];
