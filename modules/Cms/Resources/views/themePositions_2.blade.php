...
@section('content')
    ...
    <aside id="modules_list" class="custom_scroll">
        ...
        <div id="trash_div" class="dropable">{{ trans('cms::cms.drop_module_here') }} <i class="fa fa-trash-o"></i></div>
        ...
        <div class="separator_div"><b id="module_name_b">{{ trans('cms::cms.module') }}</b> {{ trans('cms::cms.attributes') }} <b id="cur_module_status"></b></div>
        ...
        <div class="btn-group" data-toggle="buttons" id="all_pages_button_group">
            ...
            <label class="btn btn-info active">
                <input type="radio" name="all_pages" id="all_pages_1" value="1"> {{ trans('cms::cms.selected_pages') }}
            </label>
            <label class="btn btn-info">
