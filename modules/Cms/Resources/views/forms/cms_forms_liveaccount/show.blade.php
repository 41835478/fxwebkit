...
{!! Form::open(['route'=>'admin.liveFormApprove']) !!}
            ...
            <div class="form-group {{ $errors->has('gender') ? 'has-error' : ''}}">
                {!! Form::label('gender', trans('cms::cms.gender').' :' ,['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('date_of_birth') ? 'has-error' : ''}}">
                {!! Form::label('date_of_birth', trans('cms::cms.date_of_birth').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('fax') ? 'has-error' : ''}}">
                {!! Form::label('fax', trans('cms::cms.fax').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('nationality') ? 'has-error' : ''}}">
                {!! Form::label('nationality', trans('cms::cms.nationality').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_code') ? 'has-error' : ''}}">
                {!! Form::label('postal_code', trans('cms::cms.postal_code').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('account_type') ? 'has-error' : ''}}">
                {!! Form::label('account_type', trans('cms::cms.account_type').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('base_currency_limit') ? 'has-error' : ''}}">
                {!! Form::label('base_currency_limit', trans('cms::cms.base_currency_limit').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('default_platform') ? 'has-error' : ''}}">
                {!! Form::label('default_platform', trans('cms::cms.default_platform').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('referring_partner') ? 'has-error' : ''}}">
                {!! Form::label('referring_partner', trans('cms::cms.referring_partner').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('fund_manager') ? 'has-error' : ''}}">
                {!! Form::label('fund_manager', trans('cms::cms.fund_manager').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('marital_status') ? 'has-error' : ''}}">
                {!! Form::label('marital_status', trans('cms::cms.marital_status').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('resident_status') ? 'has-error' : ''}}">
                {!! Form::label('resident_status', trans('cms::cms.resident_status').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('street_and_number') ? 'has-error' : ''}}">
                {!! Form::label('street_and_number', trans('cms::cms.street_and_number').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('city') ? 'has-error' : ''}}">
                {!! Form::label('city', trans('cms::cms.city').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('main_phone') ? 'has-error' : ''}}">
                {!! Form::label('main_phone', trans('cms::cms.main_phone').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('secondary_phone') ? 'has-error' : ''}}">
                {!! Form::label('secondary_phone', trans('cms::cms.secondary_phone').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('primary_email') ? 'has-error' : ''}}">
                {!! Form::label('primary_email', trans('cms::cms.primary_email').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('secondary_email') ? 'has-error' : ''}}">
                {!! Form::label('secondary_email', trans('cms::cms.secondary_email').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_street_and_number') ? 'has-error' : ''}}">
                {!! Form::label('postal_street_and_number', trans('cms::cms.postal_street_and_number').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_post_code') ? 'has-error' : ''}}">
                {!! Form::label('postal_post_code', trans('cms::cms.postal_post_code').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_city') ? 'has-error' : ''}}">
                {!! Form::label('postal_city', trans('cms::cms.postal_city').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_country') ? 'has-error' : ''}}">
                {!! Form::label('postal_country', trans('cms::cms.postal_country').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('country') ? 'has-error' : ''}}">
                {!! Form::label('country', trans('cms::cms.country').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('financial_instrument_portfolio') ? 'has-error' : ''}}">
                {!! Form::label('financial_instrument_portfolio', trans('cms::cms.financial_instrument_portfolio').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('source_funds_deposited') ? 'has-error' : ''}}">
                {!! Form::label('source_funds_deposited', trans('cms::cms.source_funds_deposited').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('other_source_funds_deposited') ? 'has-error' : ''}}">
                {!! Form::label('other_source_funds_deposited', trans('cms::cms.other_source_funds_deposited').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_risks') ? 'has-error' : ''}}">
                {!! Form::label('understand_risks', trans('cms::cms.understand_risks').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_cfd') ? 'has-error' : ''}}">
                {!! Form::label('experience_cfd', trans('cms::cms.experience_cfd :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_commodities') ? 'has-error' : ''}}">
                {!! Form::label('experience_commodities', trans('cms::cms.experience_commodities :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_forex') ? 'has-error' : ''}}">
                {!! Form::label('experience_forex', trans('cms::cms.experience_forex :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_futures') ? 'has-error' : ''}}">
                {!! Form::label('experience_futures', trans('cms::cms.experience_futures :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_options') ? 'has-error' : ''}}">
                {!! Form::label('experience_options', trans('cms::cms.experience_options :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('experience_securities') ? 'has-error' : ''}}">
                {!! Form::label('experience_securities', trans('cms::cms.experience_securities :'), ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_cfd') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_cfd', trans('cms::cms.number_of_years_cfd').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_commodities') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_commodities', trans('cms::cms.number_of_years_commodities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_forex') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_forex', trans('cms::cms.number_of_years_forex').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_futures') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_futures', trans('cms::cms.number_of_years_futures').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_options') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_options', trans('cms::cms.number_of_years_options').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_years_securities') ? 'has-error' : ''}}">
                {!! Form::label('number_of_years_securities', trans('cms::cms.number_of_years_securities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_cfd') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_cfd', trans('cms::cms.number_of_transactions_cfd').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_commodities') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_commodities', trans('cms::cms.number_of_transactions_commodities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_forex') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_forex', trans('cms::cms.number_of_transactions_forex').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_futures') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_futures', trans('cms::cms.number_of_transactions_futures').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_options') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_options', trans('cms::cms.number_of_transactions_options').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('number_of_transactions_securities') ? 'has-error' : ''}}">
                {!! Form::label('number_of_transactions_securities', trans('cms::cms.number_of_transactions_securities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_cfd') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_cfd', trans('cms::cms.average_trading_cfd').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_commodities') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_commodities', trans('cms::cms.average_trading_commodities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_forex') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_forex', trans('cms::cms.average_trading_forex').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_futures') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_futures', trans('cms::cms.average_trading_futures').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_options') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_options', trans('cms::cms.average_trading_options').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('average_trading_securities') ? 'has-error' : ''}}">
                {!! Form::label('average_trading_securities', trans('cms::cms.average_trading_securities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_cfd') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_cfd', trans('cms::cms.understand_market_cfd').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_commodities') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_commodities', trans('cms::cms.understand_market_commodities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_forex') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_forex', trans('cms::cms.understand_market_forex').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_futures') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_futures', trans('cms::cms.understand_market_futures').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_options') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_options', trans('cms::cms.understand_market_options').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_securities') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_securities', trans('cms::cms.understand_market_securities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_cfd') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_cfd', trans('cms::cms.understand_market_years_cfd').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_commodities') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_commodities', trans('cms::cms.understand_market_years_commodities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_forex') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_forex', trans('cms::cms.understand_market_years_forex').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_futures') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_futures', trans('cms::cms.understand_market_years_futures').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_options') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_options', trans('cms::cms.understand_market_years_options').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('understand_market_years_securities') ? 'has-error' : ''}}">
                {!! Form::label('understand_market_years_securities', trans('cms::cms.understand_market_years_securities').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('first_name_joint') ? 'has-error' : ''}}">
                {!! Form::label('first_name_joint', trans('cms::cms.first_name_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('second_name_joint') ? 'has-error' : ''}}">
                {!! Form::label('second_name_joint', trans('cms::cms.second_name_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('last_name_joint') ? 'has-error' : ''}}">
                {!! Form::label('last_name_joint', trans('cms::cms.last_name_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('title_joint') ? 'has-error' : ''}}">
                {!! Form::label('title_joint', trans('cms::cms.title_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('gender_joint') ? 'has-error' : ''}}">
                {!! Form::label('gender_joint', trans('cms::cms.gender_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('date_of_birth_joint') ? 'has-error' : ''}}">
                {!! Form::label('date_of_birth_joint', trans('cms::cms.date_of_birth_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('fax_joint') ? 'has-error' : ''}}">
                {!! Form::label('fax_joint', trans('cms::cms.fax_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('nationality_joint') ? 'has-error' : ''}}">
                {!! Form::label('nationality_joint', trans('cms::cms.nationality_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_code_joint') ? 'has-error' : ''}}">
                {!! Form::label('postal_code_joint', trans('cms::cms.postal_code_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('base_currency_limit_joint') ? 'has-error' : ''}}">
                {!! Form::label('base_currency_limit_joint', trans('cms::cms.base_currency_limit_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('sole_joint_account_joint') ? 'has-error' : ''}}">
                {!! Form::label('sole_joint_account_joint', trans('cms::cms.sole_joint_account_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('marital_status_joint') ? 'has-error' : ''}}">
                {!! Form::label('marital_status_joint', trans('cms::cms.marital_status_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('resident_status_joint') ? 'has-error' : ''}}">
                {!! Form::label('resident_status_joint', trans('cms::cms.resident_status_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('street_and_number_joint') ? 'has-error' : ''}}">
                {!! Form::label('street_and_number_joint', trans('cms::cms.street_and_number_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('main_phone_joint') ? 'has-error' : ''}}">
                {!! Form::label('main_phone_joint', trans('cms::cms.main_phone_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('secondary_phone_joint') ? 'has-error' : ''}}">
                {!! Form::label('secondary_phone_joint', trans('cms::cms.secondary_phone_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('primary_email_joint') ? 'has-error' : ''}}">
                {!! Form::label('primary_email_joint', trans('cms::cms.primary_email_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('secondary_email_joint') ? 'has-error' : ''}}">
                {!! Form::label('secondary_email_joint', trans('cms::cms.secondary_email_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_street_and_number_joint') ? 'has-error' : ''}}">
                {!! Form::label('postal_street_and_number_joint', trans('cms::cms.postal_street_and_number_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_post_code_joint') ? 'has-error' : ''}}">
                {!! Form::label('postal_post_code_joint', trans('cms::cms.postal_post_code_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_city_joint') ? 'has-error' : ''}}">
                {!! Form::label('postal_city_joint', trans('cms::cms.postal_city_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('postal_country_joint') ? 'has-error' : ''}}">
                {!! Form::label('postal_country_joint', trans('cms::cms.postal_country_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('country_joint') ? 'has-error' : ''}}">
                {!! Form::label('country_joint', trans('cms::cms.country_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('financial_instrument_portfolio_joint') ? 'has-error' : ''}}">
                {!! Form::label('financial_instrument_portfolio_joint', trans('cms::cms.financial_instrument_portfolio_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('source_funds_deposited_joint') ? 'has-error' : ''}}">
                {!! Form::label('source_funds_deposited_joint', trans('cms::cms.source_funds_deposited_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
            ...
            <div class="form-group {{ $errors->has('other_source_funds_deposited_joint') ? 'has-error' : ''}}">
                {!! Form::label('other_source_funds_deposited_joint', trans('cms::cms.other_source_funds_deposited_joint').' :', ['class' => 'col-sm-8 control-label']) !!}
                <div class="col-sm-4">
