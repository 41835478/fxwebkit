            ...
            <div class="sole-group-div">
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        PERSONAL DETAILS (HEREAFTER "CLIENT")
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        POSTAL ADDRESS (IF DIFFERENTFROM RESIDENTIAL ADDRESS)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        SOURCE OF FUNDS DEPOSITED WITH HOUSE OF BORSE (IF YOU SELECT "OTHER" PLEASE SPECIFY)
                    </header>
            ...
            <div class="joint-group-div" style="display:none;">
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        PERSONAL DETAILS (HEREAFTER "CLIENT") (FOR JOINT ACCOUNT)
                    </header>
                    ...
                    <div class="form-group {{ $errors->has('resident_status_joint') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-8 control-label ">
                            ...
                            {!! Form::label('resident_status_joint', trans('cms::cms.resident_status').' :', ['class' => '']) !!}
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        RESIDENTIAL ADDRESS (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        CONTACT DETAILS (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        POSTAL ADDRESS (IF DIFFERENTFROM RESIDENTIAL ADDRESS) (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        FINANCIAL BACKGROUND (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        SOURCE OF FUNDS DEPOSITED WITH HOUSE OF BORSE (IF YOU SELECT "OTHER" PLEASE SPECIFY) (FOR JOINTACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        UNDERSTAND RISKS (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        FINANCIAL MARKETS EXPERIENCE (FOR JOINT ACCOUNT)
                    </header>
                ...
                <div class="fieldsGroup">
                    <header>
                        ...
                        UNDERSTANDING OF THE MARKETS (FOR JOINT ACCOUNT)
                    </header>
