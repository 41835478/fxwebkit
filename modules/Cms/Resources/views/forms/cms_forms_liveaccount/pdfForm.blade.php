...
<head>
	...
	<style>
		...
		*, *:before, *:after {
		...
		h4{background:#e6e8e8;padding:5px;}
		h5{background:#faf2d6;padding:5px;}
		...
		.app-proccess ul li{
			width:20%;position: relative;padding:20px 0;
			display: table-cell;
    		vertical-align: middle;
		}
		...
		.app-proccess ul li strong{font-size:1.4rem;}
		.col-box{
			clear:both;
			overflow: hidden;
		}
		...
		.padding-10{padding:1px 0px 1px 8px;}
		.padding-10:after{content:'|';color:#ffffff;}
...
<div class="page">
	...
	<p>In order to open a personal trading account with House of Borse Limited (“House of Borse”) please complete the application form fully and ensure that the following are in order:</p>
		<ul>
	...
	<p>When opening a personal account with House of Borse, your application form will be reviewed together with the provided documentation as listed in Appendix c. Please therefore ensure that when submitting this application form to us, you have submitted all the requested documents to enable us to assess your application in a timely manner and revert back to you in due course.</p>
	...
	<p>For a faster processing of your application to open a personal account with House of Borse, please return a scanned copy of the duly completed application form and supporting documentation (please refer to Appendix c for the full list) directly to House of Borse:</p>
	<p><strong>Email:</strong> support@houseofborse.com</p>
	<p>Please note that in the event you submit your application to House of Borse in a scanned copy as per above, you will also need to submit the original signed application form and documentation to us by post or courier within seven (7) days of approval of the account.</p>
	
	<h3 class="margin-top-20">return oF originAl Documents</h3>
	<p>It is a requirement, as specified above, that we receive all of documents (as listed in Appendix C) in original within seven (7) days of approval of the account.<br>
...
<div class="page">
	...
	<div class="col-box margin-bottom-20">
		<div class="col-50">
			...
			<ul class="no-margin">
				<li>@if()) real_user.getAccountType()=='Self-trading' %} &check; {% else %}&#9744;{%endif%} Self-trading</li>
				<li>{% if real_user.getAccountType()=='Managed investor' %} &check; {% else %}&#9744;{%endif%} Managed investor (managed account under a fund manager)</li>
				<li>{% if real_user.getAccountType()=='Referring Partner' %} &check; {% else %}&#9744;{%endif%} Referring Partner</li>
				<li>{% if real_user.getAccountType()=='Fund manager' %} &check; {% else %}&#9744;{%endif%} Fund manager</li>
			</ul>
		</div><!--.col-50-->
		<div class="col-50 no-padding">
			...
			<div class="rectangle padding-20">{{real_user.getBaseCurrencyLimit()}}</div>
		</div><!--.col-50-->
	</div><!--.col-box-->
	...
	<div class="col-box margin-bottom-20">
			...
			<ul class="no-margin list-inline">
				<li class="padding-right-10">{% if real_user.getDefaultPlatform()=='MT4' %} &check; {% else %}&#9744;{%endif%} MT4</li>
				<li class="padding-right-10">{% if real_user.getDefaultPlatform()=='Multi-products' %} &check; {% else %}&#9744;{%endif%} Multi-products</li>
				<li class="padding-right-10">{% if real_user.getDefaultPlatform()=='Both' %} &check; {% else %}&#9744;{%endif%} Both</li>
			</ul>
	</div><!--.col-box-->
	
	<div class="col-box margin-bottom-20">
	<h4>2. introDuction(s)</h4>
	<p>Please only complete this section in the event you have been introduced to House of Borse by a third party. Please ensure to provide the full name of the third party introducer.</p>
		<div class="col-box">
			<div class="col-50">
				<p>{% if real_user.getReferringPartner()!='' %} &check; {% else %}&#9744;{%endif%} Referring Partner</p>
				<div class="rectangle padding-10">{{ real_user.getReferringPartner()}}&ensp;</div>
		</div><!--.col-50-->
		<div class="col-50">
				<p>{% if real_user.getFundManager()!='' %} &check; {% else %}&#9744;{%endif%} Fund manager</p>
                                <div class="rectangle padding-10">{{ real_user.getFundManager()}}&ensp;</div>
		</div><!--.col-50-->
		</div><!--.col-box-->
	</div><!--.col-box-->
	...
	<p>I/ We are opening the following account with House of Borse:<br>
		{% if real_user.getSoleJointAccount()=='Sole personal account' %} &check; {% else %}&#9744;{%endif%} Sole personal account<br>
		{% if real_user.getSoleJointAccount()=='Joint account' %} &check; {% else %}&#9744;{%endif%}Joint account (please also complete Appendix D for the secondary account holder)<br>
		Please note that if you are opening a joint account with House of Borse, the following parts of this application form should be completed by the primary joint account holder, and the attached Appendix D (Joint account Holder Form) should be completed for the secondary joint account holder.</p>
	</div><!--.col-box-->

	<div class="col-box margin-bottom-10">
	<h5>A. Personal Details (hereafter “client”)</h5>
	<ul class="no-margin list-inline">
		<li class="padding-right-10">{% if real_user.getTitle()=='Mr' %} &check; {% else %}&#9744;{%endif%} Mr.</li>
		<li class="padding-right-10">{% if real_user.getTitle()=='Ms' %} &check; {% else %}&#9744;{%endif%} Ms.</li>
		<li class="padding-right-10">{% if real_user.getTitle()=='Mrs' %} &check; {% else %}&#9744;{%endif%} Mrs.</li>
		<li class="padding-right-10">{% if real_user.getTitle()=='Dr' %} &check; {% else %}&#9744;{%endif%} Dr.</li>
	</ul>
		<div class="col-box margin-bottom-10">
			<div class="col-33">
				<p>First Name</p>
				<div class="rectangle padding-10">{{user.getFirstname()}}</div>
			</div><!--.col-33-->
			<div class="col-33">
				<p>Middle Name (if applicable)</p>
				<div class="rectangle padding-10">{{user.getSecondname()}}</div>
			</div><!--.col-33-->
			<div class="col-33">
				<p>Last Name</p>
				<div class="rectangle padding-10">{{user.getLastName()}}</div>
			</div><!--.col-33-->
	...
	<div class="col-box margin-bottom-10">
			<div class="col-33">
				...
				<div class="rectangle padding-10">{{real_user.getDateOfBirth|date('Y-m-d')}}</div>
			</div><!--.col-33-->
			<div class="col-33">
				<p>Nationality</p>
				<div class="rectangle padding-10">{{real_user.getNationalityLabel() }}</div>
			</div><!--.col-33-->
			<div class="col-33">
				<p>Gender</p>
				<ul class="no-margin list-inline">
					<li class="padding-right-10">{% if real_user.getGenderLabel()=='Male' %} &check; {% else %}&#9744;{%endif%}  Male</li>
					<li class="padding-right-10">{% if real_user.getGenderLabel()=='Female' %} &check; {% else %}&#9744;{%endif%}  Female</li>
				</ul>
			</div><!--.col-33-->
		</div><!--.col-box-->
		...
		<div class="col-box margin-bottom-10">
			<div class="col-33">
				...
				<ul class="no-margin list-inline">
					...
					<li class="padding-right-10">{% if real_user.getMaritalStatus()=='Single' %} &check; {% else %}&#9744;{%endif%} Single</li>
					<li class="padding-right-10">{% if real_user.getMaritalStatus()=='Married' %} &check; {% else %}&#9744;{%endif%} Married</li>
				</ul>
			</div><!--.col-33-->
			<div class="col-66">
				<p>Status</p>
                                <ul class="no-margin list-inline">
                                    <ul class="no-margin list-inline">
					<li class="padding-right-10">{% if real_user.getResidentStatus()=='Non Resident' %} &check; {% else %}&#9744;{%endif%}  Non Resident</li>
					<li class="padding-right-10">{% if real_user.getResidentStatus()=='Resident Individual' %} &check; {% else %}&#9744;{%endif%} Resident Individual</li>
					<li class="padding-right-10">{% if real_user.getResidentStatus()=='Foreign National' %} &check; {% else %}&#9744;{%endif%} Foreign National</li>
				</ul>
			</div><!--.col-66-->
...
<div class="page">
	...
	<div class="rectangle padding-10">{{ real_user.getStreetAndNumber}}</div>
	<p>Post Code</p>
	<div class="rectangle padding-10">{{real_user.getPostalCode()}}</div>
	<div class="col-box margin-bottom-30">
			<div class="col-50">
				<p>City</p>
				<div class="rectangle padding-10">{{ real_user.getCity}}</div>
			</div><!--.col-50-->
			<div class="col-50 no-padding">
				<p>Country</p>
				<div class="rectangle padding-10">{{real_user.getCountry()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
		...
		<div class="col-box margin-bottom-10">
			<div class="col-50">
				...
				<div class="rectangle padding-10">{{ real_user.getMainPhone()}}</div>
			</div><!--.col-50-->
			<div class="col-50 no-padding">
				<p>Secondary Phone Number (incl. country code)</p>
				<div class="rectangle padding-10">{{ real_user.getSecondaryPhone()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
		...
		<div class="col-box margin-bottom-10">
			<div class="col-50">
				<p>Primary Email</p>
				<div class="rectangle padding-10">{{ real_user.getPrimaryEmail()}}</div>
			</div><!--.col-50-->
			<div class="col-50 no-padding">
				<p>Secondary Email</p>
				<div class="rectangle padding-10">{{ real_user.getSecondaryEmail()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
		...
		<div class="col-box margin-bottom-30">
			<div class="col-50">
				<p>Fax</p>
				<div class="rectangle padding-10">{{real_user.getFax()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
	...
	<div class="col-box margin-bottom-10">
			<div class="col-50">
				<p>Street and number</p>
				<div class="rectangle padding-10">{{real_user.getPostalStreetAndNumber()}}</div>
			</div><!--.col-50-->
			<div class="col-50 no-padding">
				<p>Post code</p>
				<div class="rectangle padding-10">{{real_user.getPostalPostCode()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
		<div class="col-box margin-bottom-10">
			<div class="col-50">
				<p>City</p>
				<div class="rectangle padding-10">{{real_user.getPostalCity()}}</div>
			</div><!--.col-50-->
			<div class="col-50 no-padding">
				<p>Country</p>
				<div class="rectangle padding-10">{{real_user.getPostalCountry()}}</div>
			</div><!--.col-50-->
		</div><!--.col-box-->
...
(incl. cash deposits and financial instruments, excl. property) (in EUR)</small></p>
	<div class="rectangle padding-10 margin-bottom-20">{{real_user.getFinancialInstrumentPortfolio()}}</div>
	...
	<p>Please specify the source of funds deposited with House of Borse by you. Please note that House of Borse may at its sole discretion request for documentation of the source of funds.</p>
		<ul>
			<li>{% if real_user.getSourceFundsDeposited()==0 %} &check; {% else %}&#9744;{%endif%} Employment inheritance investment</li>
			<li>{% if real_user.getSourceFundsDeposited()==1 %} &check; {% else %}&#9744;{%endif%} Previous employment real estate</li>
			<li>{% if real_user.getSourceFundsDeposited()==2 %} &check; {% else %}&#9744;{%endif%} Sale of investments savings</li>
			<li>{% if real_user.getSourceFundsDeposited()==3 %} &check; {% else %}&#9744;{%endif%} Other (specify below)</li>
		</ul>
                        <div class="rectangle padding-10 margin-bottom-30">{{real_user.getOtherSourceFundsDeposited()}} </div>
		...
		<ul class="list-inline margin-bottom-20">
					<li class="padding-right-10">{% if real_user.getUnderstandRisks()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandRisks()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
		</ul>
		...
		<ul class="no-margin padding-left-10">
				<li>{% if real_user.getNumberOfYearsCfd()!=0 %} &check; {% else %}&#9744;{%endif%} Contracts for Difference (CFDs) - if yes, please complete section C</li>
				<li>{% if real_user.getNumberOfYearsCommodities()!=0 %} &check; {% else %}&#9744;{%endif%}Commodities - if yes, please complete section D</li>
				<li>{% if real_user.getNumberOfYearsForex()!=0 %} &check; {% else %}&#9744;{%endif%} Forex - if yes, please complete section E</li>
				<li>{% if real_user.getNumberOfYearsFutures()!=0 %} &check; {% else %}&#9744;{%endif%} Futures - if yes, please complete section F</li>
				<li>{% if real_user.getNumberOfYearsOptions()!=0 %} &check; {% else %}&#9744;{%endif%} Options - if yes, please complete section G</li>
				<li>{% if real_user.getNumberOfYearsSecurities()!=0 %} &check; {% else %}&#9744;{%endif%} Securities - if yes, please complete section H</li>
			</ul>
...
<div class="page">
    <div style="{% if real_user.getNumberOfYearsCfd()==0 %}   {%endif%}">
	...
	<ul class="padding-left-10 margin-bottom-20" style="">
				<li>{% if real_user.getNumberOfYearsCfd()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsCfd()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsCfd()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsCfd()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	...
	<ul class="padding-left-10 margin-bottom-20">
				<li>{% if real_user.getNumberOfTransactionsCfd()==0 and real_user.getNumberOfYearsCfd()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCfd()==1 and real_user.getNumberOfYearsCfd()!=0  %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCfd()==2  and real_user.getNumberOfYearsCfd()!=0 %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
	<p><strong>Average trading volume per month</strong></p>
	<ul class="padding-left-10 margin-bottom-30">
				<li>{% if real_user.getAverageTradingCfd()==0 and real_user.getNumberOfYearsCfd()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfd()==1  and real_user.getNumberOfYearsCfd()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfd()==2  and real_user.getNumberOfYearsCfd()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfd()==3 and real_user.getNumberOfYearsCfd()!=0  %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
        
    <div style="{% if real_user.getNumberOfYearsCommodities()==0 %}   {%endif%}">
	<h5>D. commodities trading experience</h5>
	<p><strong>Number of years you have been trading in commodities</strong></p>
	<ul class="padding-left-10 margin-bottom-30">
					<li>{% if real_user.getNumberOfYearsCommodities()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsCommodities()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsCommodities()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsCommodities()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	</ul>
	<p><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="padding-left-10 margin-bottom-30">
				<li>{% if real_user.getNumberOfTransactionsCommodities()==0  and real_user.getNumberOfYearsCommodities()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCommodities()==1  and real_user.getNumberOfYearsCommodities()!=0   %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCommodities()==2   and real_user.getNumberOfYearsCommodities()!=0  %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

	<p><strong>Average trading volume per month</strong></p>
	<ul class="padding-left-10 margin-bottom-30">
				<li>{% if real_user.getAverageTradingCommodities()==0  and real_user.getNumberOfYearsCommodities()!=0   %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==1  and real_user.getNumberOfYearsCommodities()!=0   %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==2   and real_user.getNumberOfYearsCommodities()!=0  %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==3   and real_user.getNumberOfYearsCommodities()!=0  %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
...
<div class="page">
    <div style="{% if real_user.getNumberOfYearsForex()==0 %}   {%endif%}">
	...
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfYearsForex()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsForex()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsForex()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsForex()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	<p><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfTransactionsForex()==0 and  real_user.getNumberOfYearsForex()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsForex()==1 and  real_user.getNumberOfYearsForex()!=0  %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsForex()==2  and  real_user.getNumberOfYearsForex()!=0 %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
	<p><strong>Average trading volume per month</strong></p>
		<ul class="padding-left-10 margin-bottom-30">
				<li>{% if real_user.getAverageTradingForex()==0  and  real_user.getNumberOfYearsForex()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingForex()==1  and  real_user.getNumberOfYearsForex()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingForex()==2  and  real_user.getNumberOfYearsForex()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingForex()==3 and  real_user.getNumberOfYearsForex()!=0  %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
        
    <div style="{% if real_user.getNumberOfYearsFutures()==0 %}   {%endif%}">
	<h5>F. Futures trading experience</h5>
	<p><strong>Number of years you have been trading in futures</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfYearsFutures()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsFutures()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsFutures()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsFutures()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	</ul>
	<p><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfTransactionsFutures()==0 and  real_user.getNumberOfYearsFutures()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsFutures()==1  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsFutures()==2  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
	<p><strong>Average trading volume per month</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getAverageTradingFutures()==0  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingFutures()==1  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingFutures()==2  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingFutures()==3  and  real_user.getNumberOfYearsFutures()!=0%} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
...
<div class="page">
    ...
    <div style="{% if real_user.getNumberOfYearsOptions()==0 %}   {%endif%}">
	<h5>G. Options trading experience</h5>
	<p><strong>Number of years you have been trading in Options</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfYearsOptions()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsOptions()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsOptions()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsOptions()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	<p><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfTransactionsOptions()==0 and  real_user.getNumberOfYearsOptions()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsOptions()==1 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsOptions()==2 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
	<p><strong>Average trading volume per month</strong></p>
		<ul class="padding-left-10 margin-bottom-30">
				<li>{% if real_user.getAverageTradingOptions()==0 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptions()==1 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptions()==2 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptions()==3 and  real_user.getNumberOfYearsOptions()!=0  %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
        
    <div style="{% if real_user.getNumberOfYearsSecurities()==0 %}   {%endif%}">
	<h5>H. Securities trading experience</h5>
	<p><strong>Number of years you have been trading in Securities</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfYearsSecurities()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsSecurities()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsSecurities()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsSecurities()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	</ul>
	<p><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getNumberOfTransactionsSecurities()==0 and  real_user.getNumberOfYearsSecurities()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsSecurities()==1 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsSecurities()==2 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
	<p><strong>Average trading volume per month</strong></p>
	<ul class="padding-left-10 margin-bottom-10">
				<li>{% if real_user.getAverageTradingSecurities()==0 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecurities()==1 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecurities()==2 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecurities()==3 and  real_user.getNumberOfYearsSecurities()!=0   %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
...
<div class="page">
	...
	<div class="col-box margin-bottom-10">
			<div class="col-33">
				...
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCfd()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCfd()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsCfd()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Forex (Spot and Forward)</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketForex()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketForex()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsForex()}}</div>
			...
			<div class="col-33">
				...
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketSecurities()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketSecurities()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsSecurities()}}</div>
			</div><!--.col-33-->
	...
	<div class="col-box margin-bottom-10">
			<div class="col-33">
				...
				<ul class="list-inline no-margin">
				<li class="padding-right-10">{% if real_user.getUnderstandMarketFutures()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketFutures()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsFutures()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Commodities</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCommodities()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCommodities()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsCommodities()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Options</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketOptions()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketOptions()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsOptions()}}</div>
			</div><!--.col-33-->
...
<div class="page">
	...
	<ul class="no-margin padding-left-10">
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck1()==1 %} &check; {% else %}&#9744;{%endif%} This application form is completed by and on behalf of me/ us and not by a third party.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck2()==1 %} &check; {% else %}&#9744;{%endif%} I/We have carefully read and completed this application form and affixed my/our initials to attest this on all pages of this application form submitted to House of Borse.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck3()==1 %} &check; {% else %}&#9744;{%endif%} All information provided in this application form is correct and I/ we shall be obliged to inform House of Borse immediately should any of the provided information change.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck4()==1 %} &check; {% else %}&#9744;{%endif%} I/ We acknowledge and understand that House of Borse may in its sole discretion request additional information and/ or documentation than what is listed in this application form in order to open the account. I/ We furthermore understand and accept that House of Borse may not accept my/ our application based on the provided documents/ information.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck5()==1 %} &check; {% else %}&#9744;{%endif%} I/ We am/ are aged 18 years or older.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck6()==1 %} &check; {% else %}&#9744;{%endif%} I/ We consent to electronic communication.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck7()==1 %} &check; {% else %}&#9744;{%endif%} I/ We have read and understood the risk warnings attached Appendix A to this application form.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck8()==1 %} &check; {% else %}&#9744;{%endif%} Any damages suffered by House of Borse as a result of House of Borse relying on the information in this application form that is inaccurate or false shall be borne by me/ us.</li>
	</ul>
	<p><u>Personal information submitted by me/ us to House of Borse may:</u></p>
	<ul class="no-margin padding-left-10">
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck9()==1 %} &check; {% else %}&#9744;{%endif%} Be used with and by any entity within House of Borse and its group companies.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck10()==1 %} &check; {% else %}&#9744;{%endif%} Be shared with a third party introducer (where I/ we have indicated such a third party introducer in this application form) for the purpose of completing due diligence and approving my/ our application.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck11()==1 %} &check; {% else %}&#9744;{%endif%} Be used to undertake a search with credit reference agencies or other organisations to reduce the incidence of fraud and/ or in the course of carrying out identity fraud prevention or credit control checks.</li>
		<li class="padding-bottom-10">{% if real_user.getAgreemCheck12()==1 %} &check; {% else %}&#9744;{%endif%} This application form is signed in one (1) original copy which shall at all times be kept with House of Borse.</li>
	</ul>
...
<div class="col-box bg-white" style="padding:20px;">
			...
			<div class="col-50 no-padding">
				<p><strong>Date:</strong></p>
				<div class="rectangle padding-10">{% if real_user.getSoleJointAccount()=="Joint account" %}{{ "now"|date("m/d/Y") }}{% endif %}</div>
			</div><!--.col-50-->


			<div class="col-50">
				<p><strong>Full Name:</strong></p>
				<div class="rectangle padding-10">{{ user.getFirstname() }} {{ user.getLastName() }}</div>
			</div><!--.col-50-->

			<div class="col-50 no-padding">
				<p><strong>Full Name:</strong></p>
				<div class="rectangle padding-10">{% if real_user.getSoleJointAccount()=="Joint account" %}{{ real_user.getFirstNameJoint() }} {{ real_user.getLastNameJoint() }}{% endif %}</div>
			</div><!--.col-50-->

			<div class="col-50">
				<p><strong>Title:</strong></p>
				<div class="rectangle padding-10">{{ real_user.getTitle() }}</div>
			</div><!--.col-50-->

			<div class="col-50 no-padding">
				<p><strong>Title:</strong></p>
				<div class="rectangle padding-10">{% if real_user.getSoleJointAccount()=="Joint account" %}{{ real_user.getTitleJoint() }}{% endif %}</div>
			</div><!--.col-50-->
...
<div class="page">
	...
	<div class="col-box margin-bottom-20">
		<div class="col-50">
			...
			<ul class="no-margin list-inline">
				<li class="padding-right-10">{% if real_user.getTitleJoint()=='Mr' %} &check; {% else %}&#9744;{%endif%} Mr.</li>
		<li class="padding-right-10">{% if real_user.getTitleJoint()=='Ms' %} &check; {% else %}&#9744;{%endif%} Ms.</li>
		<li class="padding-right-10">{% if real_user.getTitleJoint()=='Mrs' %} &check; {% else %}&#9744;{%endif%} Mrs.</li>
		<li class="padding-right-10">{% if real_user.getTitleJoint()=='Dr' %} &check; {% else %}&#9744;{%endif%} Dr.</li>
	</ul>
			<div class="rectangle padding-10">{{real_user.getFirstNameJoint()}}</div>
			<p><strong>Middle Name(s) (if applicable)</strong></p>
			<div class="rectangle padding-10"></div>
			<p><strong>Last Name(s)</strong></p>
			<div class="rectangle padding-10">{{real_user.getSecondNameJoint()}}</div>
			<p><strong>Date of Birth (DD/MM/YYYY)</strong></p>
			<div class="rectangle padding-10">{{real_user.getLastNameJoint()}}</div>
		</div><!--.col-50-->
		...
		<div class="col-50 no-padding">
			...
			<div class="rectangle padding-10">{{ real_user.getStreetAndNumberJoint}}</div>
			<p><strong>Post Code</strong></p>
			<div class="rectangle padding-10">{{real_user.getPostalCodeJoint()}}</div>
			<p><strong>City</strong></p>
			<div class="rectangle padding-10">{{ real_user.getCityJoint}}</div>
			<p><strong>Country</strong></p>
			<div class="rectangle padding-10">{{real_user.getCountryJoint()}}</div>
		</div><!--.col-50-->
	...
	<div class="col-box margin-bottom-20">
		<div class="col-50">
			...
			<div class="rectangle padding-10">{{ real_user.getMainPhoneJoint()}}</div>
			<p><strong>Secondary Phone Number (incl. country code)</strong></p>
			<div class="rectangle padding-10">{{ real_user.getSecondaryPhoneJoint()}}</div>
			<p><strong>Primary Email</strong></p>
			<div class="rectangle padding-10">{{ real_user.getPrimaryEmailJoint()}}</div>
			<p><strong>Secondary Email</strong></p>
			<div class="rectangle padding-10">{{ real_user.getSecondaryEmailJoint()}}</div>
			<p><strong>Fax</strong></p>
			<div class="rectangle padding-10">{{real_user.getFaxJoint()}}</div>
		</div><!--.col-50-->
		<div class="col-50">
			<h5>B. residential address</h5>
			<p><strong>Street and Number</strong></p>
			<div class="rectangle padding-10">{{real_user.getPostalStreetAndNumberJoint()}}</div>
			<p><strong>Post Code</strong></p>
			<div class="rectangle padding-10">{{real_user.getPostalPostCodeJoint()}}</div>
			<p><strong>City</strong></p>
			<div class="rectangle padding-10">{{real_user.getPostalCityJoint()}}</div>
			<p><strong>Country</strong></p>
			<div class="rectangle padding-10">{{real_user.getPostalCountryJoint()}}</div>
		</div><!--.col-50-->		
	</div><!--.col-box-->
	...
	<div class="col-box margin-bottom-20">
		<div class="col-50">
			...
			<div class="rectangle padding-20">{{real_user.getFinancialInstrumentPortfolioJoint()}}</div>
		</div><!--.col-50-->
		<div class="col-50">
			...
			<p>Please specify the source of funds deposited with House of Borse by the client. Please note that House of Borse may at its sole discretion request for documentation of the source of funds.</p>
				<div class="col-box margin-bottom-20">
					<div class="col-50">
					<ul>
                                            <li>{% if real_user.getSourceFundsDepositedJoint()==0 %} &check; {% else %}&#9744;{%endif%} Employment</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==1 %} &check; {% else %}&#9744;{%endif%} Inheritance</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==2 %} &check; {% else %}&#9744;{%endif%} Investment</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==3 %} &check; {% else %}&#9744;{%endif%} Previous Employment</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==4 %} &check; {% else %}&#9744;{%endif%} Real Estate</li>
						
		</ul>
					</div><!--.col-50-->
					<div class="col-50">
					<ul>
							<li>{% if real_user.getSourceFundsDepositedJoint()==5 %} &check; {% else %}&#9744;{%endif%} Sale of investments</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==6 %} &check; {% else %}&#9744;{%endif%} Savings</li>
						<li>{% if real_user.getSourceFundsDepositedJoint()==7 %} &check; {% else %}&#9744;{%endif%} Other (specify below)</li>
						<div class="rectangle padding-10">{{  real_user.getOtherSourceFundsDepositedJoint() }}</div>
					</ul>
					</div><!--.col-50-->
				</div><!--.col-box-->
		</div><!--.col-50-->		
...
<div class="page">
	...
	<p>Forex and contract for Difference are leveraged products. they may not be suitable for you as they carry a high degree of risk to your capital and you can lose more than your initial investment. You must ensure that you understand all of the risks as furthermore elaborated on in Appendix A (High risk investment notice).<br><br>
		...
		<ul class="no-margin list-inline">
				<li class="padding-right-10">{% if real_user.getUnderstandRisksJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandRisksJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
		</ul>
		<h5 class="margin-top-20">B. Financial markets experience</h5>
		<p>Please indicate below the financial market(s) you have traded in within the past 3 years.</p>
		<ul class="no-margin">
			<li>{% if real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Contracts for Difference (CFDs) - if yes, please complete section C</li>
				<li>{% if real_user.getNumberOfYearsCommoditiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%}Commodities - if yes, please complete section D</li>
				<li>{% if real_user.getNumberOfYearsForexJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Forex - if yes, please complete section E</li>
				<li>{% if real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Futures - if yes, please complete section F</li>
				<li>{% if real_user.getNumberOfYearsOptionsJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Options - if yes, please complete section G</li>
				<li>{% if real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Securities - if yes, please complete section H</li>
			</ul>
                         <div style="{% if real_user.getNumberOfYearsCfdJoint()==0 %}   {%endif%}">
		<h5 class="margin-top-20">C. contract for Differences (CFDs) trading experience</h5>
		<p><strong>Number of years you have been trading in CFDs</strong></p>
		<ul class="no-margin">
			<li>{% if real_user.getNumberOfYearsCfdJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsCfdJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsCfdJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsCfdJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
		...
		<ul class="no-margin">
			<li>{% if real_user.getNumberOfTransactionsCfdJoint()==0 and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCfdJoint()==1  and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCfdJoint()==2  and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>
		<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
			<ul class="no-margin">
				<li>{% if real_user.getAverageTradingCfdJoint()==0 and  real_user.getNumberOfYearsCfdJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfdJoint()==1  and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfdJoint()==2  and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingCfdJoint()==3  and  real_user.getNumberOfYearsCfdJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
                         </div>
...
<div class="page">
    <div style="{% if real_user.getNumberOfYearsCommoditiesJoint()==0 %}   {%endif%}">

	<h4>D. commodities trading experience</h4>
	<p><strong>Number of years you have been trading in commodities</strong></p>
	<ul class="no-margin">
			<li>{% if real_user.getNumberOfYearsCommoditiesJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsCommoditiesJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsCommoditiesJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsCommoditiesJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
		</ul>

	<p class="margin-top-10"><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getNumberOfTransactionsCommoditiesJoint()==0 and  real_user.getNumberOfYearsCommoditiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCommoditiesJoint()==1  and  real_user.getNumberOfYearsCommoditiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsCommoditiesJoint()==2 and  real_user.getNumberOfYearsCommoditiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

	<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getAverageTradingCommodities()==0 and  real_user.getNumberOfYearsCommoditiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==1 and  real_user.getNumberOfYearsCommoditiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==2 and  real_user.getNumberOfYearsCommoditiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingCommodities()==3  and  real_user.getNumberOfYearsCommoditiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
        <div style="{% if real_user.getNumberOfYearsForexJoint()==0 %}   {%endif%}">
	
	<h5 class="margin-top-20">E. Forex (spot or Forward) trading experience</h5>
	<p><strong>Number of years you have been trading in forex</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getNumberOfYearsForexJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsForexJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsForexJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsForexJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
	<p class="margin-top-10"><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getNumberOfTransactionsForexJoint()==0 and  real_user.getNumberOfYearsForexJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsForexJoint()==1 and  real_user.getNumberOfYearsForexJoint()!=0  %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsForexJoint()==2 and  real_user.getNumberOfYearsForexJoint()!=0  %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

	<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getAverageTradingForexJoint()==0 and  real_user.getNumberOfYearsForexJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingForexJoint()==1  and  real_user.getNumberOfYearsForexJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingForexJoint()==2  and  real_user.getNumberOfYearsForexJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingForexJoint()==3  and  real_user.getNumberOfYearsForexJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
        </div>
...
<div class="page">
     <div style="{% if real_user.getNumberOfYearsFuturesJoint()==0 %}   {%endif%}">

	<h5>F. Futures trading experience</h5>
	<p><strong>Number of years you have been trading in futures</strong></p>
	<ul class="no-margin">
		<li>{% if real_user.getNumberOfYearsFuturesJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsFuturesJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsFuturesJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsFuturesJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>

<p class="margin-top-10"><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
<ul class="no-margin">
		<li>{% if real_user.getNumberOfTransactionsFuturesJoint()==0 and  real_user.getNumberOfYearsFuturesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsFuturesJoint()==1  and  real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsFuturesJoint()==2  and  real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
<ul class="no-margin">
		<li>{% if real_user.getAverageTradingFuturesJoint()==0  and  real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingFuturesJoint()==1  and  real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingFuturesJoint()==2  and  real_user.getNumberOfYearsFuturesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingFuturesJoint()==3 and  real_user.getNumberOfYearsFuturesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
     </div>
        <div style="{% if real_user.getNumberOfYearsOptionsJoint()==0 %}   {%endif%}">
...
<ul class="no-margin">
		<li>{% if real_user.getNumberOfYearsOptionsJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsOptionsJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsOptionsJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsOptionsJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>
<p class="margin-top-10"><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
<ul class="no-margin">
		<li>{% if real_user.getNumberOfTransactionsOptionsJoint()==0 and  real_user.getNumberOfYearsOptionsJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsOptionsJoint()==1 and  real_user.getNumberOfYearsOptionsJoint()!=0   %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsOptionsJoint()==2 and  real_user.getNumberOfYearsOptionsJoint()!=0   %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
<ul class="no-margin">
		<li>{% if real_user.getAverageTradingOptionsJoint()==0  and  real_user.getNumberOfYearsOptionsJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptionsJoint()==1 and  real_user.getNumberOfYearsOptionsJoint()!=0   %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptionsJoint()==2  and  real_user.getNumberOfYearsOptionsJoint()!=0  %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingOptionsJoint()==3 and  real_user.getNumberOfYearsOptionsJoint()!=0   %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
        </div>
...
<div class="page">
    <div style="{% if real_user.getNumberOfYearsSecuritiesJoint()==0 %}   {%endif%}">

	<h5>H. securities trading experience</h5>
	<p><strong>Number of years you have been trading in securities</strong></p>
	<ul class="no-margin">
	<li>{% if real_user.getNumberOfYearsSecuritiesJoint()==1 %} &check; {% else %}&#9744;{%endif%} Less than 1 year</li>
				<li>{% if real_user.getNumberOfYearsSecuritiesJoint()==2 %} &check; {% else %}&#9744;{%endif%} 1 to 3 years</li>
				<li>{% if real_user.getNumberOfYearsSecuritiesJoint()==3 %} &check; {% else %}&#9744;{%endif%} 3 to 5 years</li>
				<li>{% if real_user.getNumberOfYearsSecuritiesJoint()==4 %} &check; {% else %}&#9744;{%endif%} More than 5 years</li>
	</ul>

<p class="margin-top-10"><strong>Number of transactions of significant size carried out per quarter in the past 12 months</strong></p>
<ul class="no-margin">
	<li>{% if real_user.getNumberOfTransactionsSecuritiesJoint()==0 and  real_user.getNumberOfYearsSecuritiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} Less than 10 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsSecuritiesJoint()==1 and  real_user.getNumberOfYearsSecuritiesJoint()!=0  %} &check; {% else %}&#9744;{%endif%} 10 to 20 transactions</li>
				<li>{% if real_user.getNumberOfTransactionsSecuritiesJoint()==2  and  real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 20 transactions</li>
	</ul>

<p class="margin-top-10"><strong>Average trading volume per month</strong></p>
<ul class="no-margin">
	<li>{% if real_user.getAverageTradingSecuritiesJoint()==0  and  real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} Less than 30,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecuritiesJoint()==1  and  real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 30,000 to 60,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecuritiesJoint()==2  and  real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} 60,000 to 300,000 GBP</li>
				<li>{% if real_user.getAverageTradingSecuritiesJoint()==3  and  real_user.getNumberOfYearsSecuritiesJoint()!=0 %} &check; {% else %}&#9744;{%endif%} More than 300,000 GBP</li>
	</ul>
    </div>
...
<div class="col-box margin-bottom-10">
			<div class="col-33">
				<p><strong>Contracts for difference (CFDs)</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCfdJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCfdJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsCfdJoint()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Forex (Spot or Forward)</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketForexJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketForexJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsForexJoint()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Securities</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketSecuritiesJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketSecuritiesJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsSecuritiesJoint()}}</div>
			</div><!--.col-33-->
	</div><!--.col-box-->
	...
	<div class="col-box margin-bottom-10">
			<div class="col-33">
				<p><strong>Futures</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketFuturesJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketFuturesJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsFuturesJoint()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Commodities</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCommoditiesJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketCommoditiesJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
				</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsCommoditiesJoint()}}</div>
			</div><!--.col-33-->

			<div class="col-33">
				<p><strong>Options</strong></p>
				<ul class="list-inline no-margin">
					<li class="padding-right-10">{% if real_user.getUnderstandMarketOptionsJoint()==0 %} &check; {% else %}&#9744;{%endif%} Yes</li>
					<li class="padding-right-10">{% if real_user.getUnderstandMarketOptionsJoint()==1 %} &check; {% else %}&#9744;{%endif%} No</li>
			</ul>
				<p>If “Yes”, please specify number of years</p>
				<div class="rectangle padding-10">{{real_user.getUnderstandMarketYearsOptionsJoint()}}</div>
			</div><!--.col-33-->
	</div><!--.col-box-->
	...
	<div class="col-box bg-white" style="padding:20px;">
			...
			<div class="col-50">
				<p><strong>Full Name:</strong></p>
				<div class="rectangle padding-10">{% if real_user.getSoleJointAccount()=="Joint account" %}{{ user.getFirstname() }} {{ user.getLastName() }}{% endif %}</div>
			</div><!--.col-50-->
			...
			<div class="col-50">
				<p><strong>Title:</strong></p>
				<div class="rectangle padding-10">{% if real_user.getSoleJointAccount()=="Joint account" %}{{ real_user.getTitle() }}{% endif %}</div>
			</div><!--.col-50-->
