<div class="container">
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="{{ asset('pluton/images/Service1.png') }}" alt="service 1">
                            </div>
                            <h3>Modern Design</h3>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="{{ asset('pluton/images/Service2.png') }}" alt="service 2" />
                            </div>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="{{ asset('pluton/images/Service3.png') }}" alt="service 3">
                            </div>
                            <h3>Clean Code</h3>
