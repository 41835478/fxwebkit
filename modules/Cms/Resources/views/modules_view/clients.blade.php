                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{ asset('pluton/images/Client1.png') }}" class="centered" alt="client 1">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{ asset('pluton/images/Client2.png') }}" class="centered" alt="client 2">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="{{ asset('pluton/images/Client3.png') }}" class="centered" alt="client 3">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
