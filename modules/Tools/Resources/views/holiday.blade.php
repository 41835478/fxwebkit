            ...
            <div class="table-light">
                ...
                <div class="table-header">{{ trans('tools::tools.holiday') }}
                    ...
                    <a href="{{ route('tools.addHoliday') }}" style="float:right;">
                        <input name="new_menu_submit" class="btn btn-primary btn-flat" type="button" value="{{ trans('tools::tools.add_holiday') }}"> </a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr class='{{ $class }}'>     
                            ...
                            <td>
                                ...
                                <a href="{{ route('tools.holidayDetails').'?holiday_id='.$oResult->id }}" class="fa fa-file-text-o"></a>
                            </td>
