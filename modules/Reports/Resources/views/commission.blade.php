                            ...
                            @if (count($oResults[0]))
                                ...
                                @foreach($oResults[0] as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td><a href="{{ route('admin.reports.closedOrders').'?search=1&symbol='.$oResult->SYMBOL.'&order=TICKET&sort=desc'}}"><span class="label label-info"> {{trans('reports::reports.details')}}</span></a></td>
