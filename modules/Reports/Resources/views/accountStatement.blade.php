            ...
            <div class="stat-panel no-margin-b">
                <div class="stat-row">
                    <div class="stat-counters bg-info no-padding text-center">
                        ...
                        <div class="stat-cell col-xs-4 padding-xs-vr">
                            <span class="text-xs">Leverage :  </span>
                        </div>
                        <div class="stat-cell col-xs-4 padding-xs-vr">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="no-warp">{!! th_sort(trans('general.Login'), 'LOGIN', $oOpenResults) !!}</th>
							...
							<th class="no-warp">{!! th_sort(trans('general.Commission'), 'COMMISSION', $oOpenResults) !!}</th>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="no-warp">{!! th_sort(trans('general.OpenTime'), 'OPEN_TIME', $oCloseResults) !!}</th>
							<th class="no-warp">{!! th_sort(trans('general.Login'), 'LOGIN', $oCloseResults) !!}</th>
							...
							<th class="no-warp">{!! th_sort(trans('general.CloseTime'), 'CLOSE_TIME', $oCloseResults) !!}</th>
							<th class="no-warp">{!! th_sort(trans('general.Commission'), 'COMMISSION', $oCloseResults) !!}</th>
							<th class="no-warp">{!! th_sort(trans('general.Taxes'), 'TAXES', $oCloseResults) !!}</th>
