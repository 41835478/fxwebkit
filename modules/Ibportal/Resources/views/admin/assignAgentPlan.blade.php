...
@section('title', trans('ibportal::ibportal.assignAgentPlan'))
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('fxweb.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                <div class="col-lg-12">
                    <h4 class="page-title">{{ trans('ibportal::ibportal.assignAgentPlan') }}</h4>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        <li><a href="#">{{ trans('ibportal::ibportal.ModuleTitle') }}</a></li>
                        <li class="active">{{ trans('ibportal::ibportal.assignAgentPlan') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                    ...
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-20">{{ trans('ibportal::ibportal.tableDescription') }}</p>
                            ...
                            <div class="panel-heading">
                                <span class="panel-title">{{ trans('ibportal::ibportal.assignAgentPlan') }}</span>
                            </div>
...
@section('hidden')
    ...
    <div class="page-header">
        <h1>{{ trans('ibportal::ibportal.assignAgentPlan') }}</h1>
    </div>
