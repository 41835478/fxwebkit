...
@section('title', trans('ibportal::ibportal.OpenOrders'))
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('fxweb.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                <div class="col-lg-12">
                    <h4 class="page-title">{{ trans('ibportal::ibportal.OpenOrders') }}</h4>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        <li><a href="#">{{ trans('ibportal::ibportal.ModuleTitle') }}</a></li>
                        <li class="active">{{ trans('ibportal::ibportal.OpenOrders') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
...
<div class="  theme-default page-mail" >
    ...
    <div class="mail-container " >
        <div class="mail-container-header">
            {{ trans('ibportal::ibportal.OpenOrders') }}
        </div>
